# Figma MCP コーディングプロンプト

## 基本設定

Figma MCP から取得したデザインを、以下の規約に従って HTML+SCSS を出力してください。
...
module 内の scss がコンポーネントの SCSS です。ここを参照し、適宜コンポーネントを使用すること。
...
- ワードプレスの場合画像パスは`<?php echo get_template_directory_uri(); ?>/images/`を使用
